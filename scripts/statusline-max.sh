...
# LOC
printf "${RED}⚐${RESET} ${WHITE}LOC:${RESET} ${DIM}${LOC_CITY}${RESET}${SEP}${WHITE}DUB:${RESET} ${CYAN}${DUB_TIME}${RESET}${DIM},${RESET} ${WHITE}ET:${RESET} ${CYAN}${NYSE_TIME}${RESET} ${DIM}[${RESET}${MARKET_TAG}${DIM}]${RESET}${SEP}${TEMP_COLOR}${LOC_WEATHER}${RESET}\n"
